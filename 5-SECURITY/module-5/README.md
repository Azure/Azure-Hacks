...
## Securing Data in Use with Confidential Virtual Machines

### Overview
Confidential Computing protects data while it's being processed, not just at rest or in transit. Azure Confidential VMs use hardware-based trusted execution environments (TEEs) to ensure that even cloud administrators cannot access your data while it's being processed.

### Learning Objectives
By completing this module, you will:
- Understand Confidential Computing concepts and use cases
- Deploy Azure Confidential VMs with encrypted memory
- Configure confidential boot disks for enhanced security
- Perform VM attestation to verify security guarantees
- Recognize when to use Confidential Computing for sensitive workloads

### Prerequisites
- Completion of Module 2 (Network Security)
- Understanding of VM deployment concepts
...
### Task 1: Deploy a Confidential Virtual Machine
**Goal**: Create and configure an Azure Confidential VM with encrypted memory protection

**What you'll do**: Deploy a Confidential VM that protects your data and code from unauthorized access, even by cloud infrastructure administrators.

**Success Criteria**: 
- Confidential VM successfully deployed
- VM configured with appropriate security settings
- Understanding of confidential computing benefits and limitations
- Confidential boot disk configured for additional security

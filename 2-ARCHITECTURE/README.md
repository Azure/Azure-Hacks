# Day 5 & 6: Azure Architecture Hackathon

## Welcome to Day 5 & 6!

This two-day hackathon focuses on architecting robust, scalable N-tier applications on Azure. You'll design and implement solutions covering the three fundamental pillars: Compute, Storage, and Connectivity, while applying architectural best practices learned from previous days.

## Schedule (2 Days)

**Day 5 — Foundations**
- Architecture foundations: Compute, Storage, Connectivity
- Select a blueprint, deploy resources, and monitor with Azure Monitor
- Challenges 0–3

**Day 6 — Networking & Security**
- Network architecture: VNets, Private Links, securing resources
- RBAC, Azure Key Vault, and the Well-Architected Framework
- Challenges 4–7

## Learning Objectives

By the end of Day 5 & 6, you will:
...
This challenge series will guide you through architecting a secure, scalable N-tier application on Microsoft Azure, building upon the foundations established in previous days.
